...
export class GetTagsByNoteIdAction {
  constructor(private readonly getTagsByNoteIdTransactionScript: GetTagsByNoteIdTransactionScript) {}
  ...
  async apply(
    ...
    return this.getTagsByNoteIdTransactionScript.apply(Number(id), user.userId);
  }
} 