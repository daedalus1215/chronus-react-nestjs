...
export class Delete_noteReferenceColumnFor_timeTracksTable1744246133546
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_time_track"("id", "userId", "noteId", "date", "startTime", "durationMinutes", "note", "createdAt", "updatedAt") SELECT "id", "userId", "noteId", "date", "startTime", "durationMinutes", "note", "createdAt", "updatedAt" FROM "time_track"`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "time_track"("id", "userId", "noteId", "date", "startTime", "durationMinutes", "note", "createdAt", "updatedAt") SELECT "id", "userId", "noteId", "date", "startTime", "durationMinutes", "note", "createdAt", "updatedAt" FROM "temporary_time_track"`
    );
