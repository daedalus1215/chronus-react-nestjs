...
export class Alter_archiveDateAndDoneDate_checkItemsTable1747186225778
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `UPDATE "check_items" SET "done_date" = datetime('now') WHERE "done_date" IS NULL`
    );
    ...
    await queryRunner.query(
      `INSERT INTO "temporary_check_items"("id", "created_at", "updated_at", "name", "done_date", "note_id") SELECT "id", "created_at", "updated_at", "name", "done_date", "note_id" FROM "check_items"`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "check_items"("id", "created_at", "updated_at", "name", "done_date", "note_id") SELECT "id", "created_at", "updated_at", "name", "done_date", "note_id" FROM "temporary_check_items"`
    );
    await queryRunner.query(`DROP TABLE "temporary_check_items"`);
  }
}
