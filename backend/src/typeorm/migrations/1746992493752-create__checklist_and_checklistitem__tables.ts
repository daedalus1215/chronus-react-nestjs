...
export class Create_checklistAndChecklistitem_tables1746992493752 implements MigrationInterface {
    name = 'Create_checklistAndChecklistitem_tables1746992493752'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "checklist_items" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL)`);
        await queryRunner.query(`CREATE TABLE "checklists" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL)`);
        await queryRunner.query(`CREATE TABLE "checklists_checklistItems" ("checklist_id" integer NOT NULL, "checklist_item_id" integer NOT NULL, PRIMARY KEY ("checklist_id", "checklist_item_id"))`);
        ...
        await queryRunner.query(`DROP TABLE "time_track"`);
        await queryRunner.query(`ALTER TABLE "temporary_time_track" RENAME TO "time_track"`);
        await queryRunner.query(`CREATE TABLE "temporary_notes" ("id" integer PRIMARY KEY, "name" text NOT NULL, "user_id" text NOT NULL, "memo_id" integer, "archived_date" text, "created_at" text NOT NULL, "updated_at" text NOT NULL, "checklist_id" integer, CONSTRAINT "UQ_2e0e1d8a2d15df140cecabfd389" UNIQUE ("checklist_id"))`);
        await queryRunner.query(`INSERT INTO "temporary_notes"("id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at") SELECT "id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at" FROM "notes"`);
        await queryRunner.query(`DROP TABLE "notes"`);
        await queryRunner.query(`ALTER TABLE "temporary_notes" RENAME TO "notes"`);
        ...
        await queryRunner.query(`DROP TABLE "tags"`);
        await queryRunner.query(`ALTER TABLE "temporary_tags" RENAME TO "tags"`);
        await queryRunner.query(`CREATE TABLE "temporary_notes" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "user_id" varchar NOT NULL, "memo_id" integer, "archived_date" datetime, "created_at" text NOT NULL DEFAULT (datetime('now')), "updated_at" text NOT NULL DEFAULT (datetime('now')), "checklist_id" integer, CONSTRAINT "UQ_2e0e1d8a2d15df140cecabfd389" UNIQUE ("checklist_id"), CONSTRAINT "UQ_571a925e7a956c24701f01af899" UNIQUE ("memo_id"))`);
        await queryRunner.query(`INSERT INTO "temporary_notes"("id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at", "checklist_id") SELECT "id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at", "checklist_id" FROM "notes"`);
        await queryRunner.query(`DROP TABLE "notes"`);
        await queryRunner.query(`ALTER TABLE "temporary_notes" RENAME TO "notes"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_notes" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "user_id" varchar NOT NULL, "memo_id" integer, "archived_date" datetime, "created_at" text NOT NULL DEFAULT (datetime('now')), "updated_at" text NOT NULL DEFAULT (datetime('now')), "checklist_id" integer, CONSTRAINT "UQ_2e0e1d8a2d15df140cecabfd389" UNIQUE ("checklist_id"), CONSTRAINT "UQ_571a925e7a956c24701f01af899" UNIQUE ("memo_id"), CONSTRAINT "FK_2d85c0c4df4bdc951cdd0f94650" FOREIGN KEY ("memo_id") REFERENCES "memos" ("id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_a142a608248254f31569914f790" FOREIGN KEY ("checklist_id") REFERENCES "checklists" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_notes"("id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at", "checklist_id") SELECT "id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at", "checklist_id" FROM "notes"`);
        await queryRunner.query(`DROP TABLE "notes"`);
        await queryRunner.query(`ALTER TABLE "temporary_notes" RENAME TO "notes"`);
        ...
        await queryRunner.query(`DROP TABLE "tag_notes"`);
        await queryRunner.query(`ALTER TABLE "temporary_tag_notes" RENAME TO "tag_notes"`);
        await queryRunner.query(`DROP INDEX "IDX_a252955cde6890ec98e3b6be48"`);
        await queryRunner.query(`DROP INDEX "IDX_46dc0e7b4af4c27094416409a6"`);
        await queryRunner.query(`CREATE TABLE "temporary_checklists_checklistItems" ("checklist_id" integer NOT NULL, "checklist_item_id" integer NOT NULL, CONSTRAINT "FK_a252955cde6890ec98e3b6be48f" FOREIGN KEY ("checklist_id") REFERENCES "checklists" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_46dc0e7b4af4c27094416409a66" FOREIGN KEY ("checklist_item_id") REFERENCES "checklist_items" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, PRIMARY KEY ("checklist_id", "checklist_item_id"))`);
        await queryRunner.query(`INSERT INTO "temporary_checklists_checklistItems"("checklist_id", "checklist_item_id") SELECT "checklist_id", "checklist_item_id" FROM "checklists_checklistItems"`);
        await queryRunner.query(`DROP TABLE "checklists_checklistItems"`);
        await queryRunner.query(`ALTER TABLE "temporary_checklists_checklistItems" RENAME TO "checklists_checklistItems"`);
        await queryRunner.query(`CREATE INDEX "IDX_a252955cde6890ec98e3b6be48" ON "checklists_checklistItems" ("checklist_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_46dc0e7b4af4c27094416409a6" ON "checklists_checklistItems" ("checklist_item_id") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_46dc0e7b4af4c27094416409a6"`);
        await queryRunner.query(`DROP INDEX "IDX_a252955cde6890ec98e3b6be48"`);
        await queryRunner.query(`ALTER TABLE "checklists_checklistItems" RENAME TO "temporary_checklists_checklistItems"`);
        await queryRunner.query(`CREATE TABLE "checklists_checklistItems" ("checklist_id" integer NOT NULL, "checklist_item_id" integer NOT NULL, PRIMARY KEY ("checklist_id", "checklist_item_id"))`);
        await queryRunner.query(`INSERT INTO "checklists_checklistItems"("checklist_id", "checklist_item_id") SELECT "checklist_id", "checklist_item_id" FROM "temporary_checklists_checklistItems"`);
        await queryRunner.query(`DROP TABLE "temporary_checklists_checklistItems"`);
        await queryRunner.query(`CREATE INDEX "IDX_46dc0e7b4af4c27094416409a6" ON "checklists_checklistItems" ("checklist_item_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_a252955cde6890ec98e3b6be48" ON "checklists_checklistItems" ("checklist_id") `);
        ...
        await queryRunner.query(`INSERT INTO "notes"("id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at", "checklist_id") SELECT "id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at", "checklist_id" FROM "temporary_notes"`);
        ...
        await queryRunner.query(`ALTER TABLE "notes" RENAME TO "temporary_notes"`);
        await queryRunner.query(`CREATE TABLE "notes" ("id" integer PRIMARY KEY, "name" text NOT NULL, "user_id" text NOT NULL, "memo_id" integer, "archived_date" text, "created_at" text NOT NULL, "updated_at" text NOT NULL, "checklist_id" integer, CONSTRAINT "UQ_2e0e1d8a2d15df140cecabfd389" UNIQUE ("checklist_id"))`);
        await queryRunner.query(`INSERT INTO "notes"("id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at", "checklist_id") SELECT "id", "name", "user_id", "memo_id", "archived_date", "created_at", "updated_at", "checklist_id" FROM "temporary_notes"`);
        await queryRunner.query(`DROP TABLE "temporary_notes"`);
