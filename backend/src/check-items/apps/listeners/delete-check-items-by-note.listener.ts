...
import {
  ...
  DeleteCheckItemsByNoteCommand,
} from 'src/shared-kernel/domain/cross-domain-commands/check-items/delete-check-items-by-note.command';
...
export class DeleteCheckItemsByNoteListener {
  ...
  async handleDeleteCheckItems(
    command: DeleteCheckItemsByNoteCommand
  ): Promise<void> {
